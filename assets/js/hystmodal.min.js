...
target1 = document.querySelector('#blog1');
target2 = document.querySelector('#blog2');
target3 = document.querySelector('#blog3');
...
const callback = function(mutationsList, observer) {
    for (const mutation of mutationsList) {
        if (mutation.type === "attributes") {
            if(mutation.target.classList.contains("hystmodal--active")){
